...
class DatasetApp:
    ...
    def browse_file(self):
        file_path = filedialog.asksaveasfilename(defaultextension=f".{self.format_var.get().lower()}",
    ...
    def add_column(self):
        ...
        column_type_var = tk.StringVar(value="Name")
        ...
        remove_button = ttk.Button(column_frame, text="Remove", 
    ...
    def remove_column(self, frame, column_name_var, column_type_var):
    ...
    def generate_dataset(self):
        ...
        columns_config = [(col[0].get(), col[1].get()) for col in self.columns]
